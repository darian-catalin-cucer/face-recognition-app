...
public class ImageUtils
{
     ...
     * @param output        A pre-allocated array for the ARGB 8:8:8:8 output data.
     */
    private static native void convertYUV420ToARGB8888(byte[] y, byte[] u, byte[] v, int[] output, int width, int height, int yRowStride,
                                                       int uvRowStride, int uvPixelStride, boolean halfSize);
    ...
    public static Bitmap handleSamplingAndRotationBitmap(Context context, String selectedImage) throws IOException
    {
        int MAX_HEIGHT = 1500;
        int MAX_WIDTH = 1500;
